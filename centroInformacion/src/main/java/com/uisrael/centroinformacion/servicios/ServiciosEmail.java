...
public class ServiciosEmail {
    ...
    public void sendMail(String emailId, String token) {
        ...
        try {
            ...
            mimeHelper.setText("<html><body>Hola,<br/><a href='http://localhost:8080/centroInformacion/newPassword/" + emailId + "/" + token + "/'> Haga click en el enlace</a> para cambiar su contraseña</body></html>", true);
